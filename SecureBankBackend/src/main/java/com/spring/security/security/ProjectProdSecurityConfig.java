...
//                        .requestMatchers("/myCards").hasAuthority("VIEWCARDS")
    ...
    public AuthenticationManager authenticationManager(UserDetailsService userDetailsService,
        ...
        SecureBankProdUsernamePasswordAuthenticationProvider authenticationProvider
                = new SecureBankProdUsernamePasswordAuthenticationProvider(userDetailsService, passwordEncoder);
